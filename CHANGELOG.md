...
## 1.6.0
- Added: 增强提示词条目美化能力，补充更完整的生成流程与编辑体验。
- Added: 新增原生条目更多操作按钮，优化常用条目动作的访问方式。
- Added: 快照管理面板新增快照转移操作，并优化相关交互。
- Added: 正则分组控制扩展到更多作用域，补齐批量分组入口与管理流程。
- Changed: 预设条目分组在复制、移动、编辑等操作后尽量保持原有分组结构。
- Changed: 优化快照存储与缝合同步逻辑，改进状态面板中未分组条目的展示方式。
- Changed: 优化传输弹窗中的预设选择器布局，以及美化弹窗和条目操作区的缩放表现。
- Removed: 移除预设比较中的更新日志生成功能及相关界面入口。
- Fixed: 降低预设条目更多按钮的切换延迟，修复部分美化弹窗与条目操作区的显示问题。
